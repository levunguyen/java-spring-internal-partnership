...
<header>
	<div class="logo col-md-6 col-sm-6 col-xs-5">
...
<!-- 				</h2> -->
			...
			<div class="user-information">
				<div class="btn-group col-xs-3 col-sm-2 col-md-2 pull-right avatar-user">
					<button type="button" class="btn">
						<img alt="partnership"
								src="/partnership-web/resource/images/avatar-small.jpg"	>
					</button>
					...
					<ul class="dropdown-menu">						
						<li>User name:</li>
						<li><strong>${pageContext.request.userPrincipal.name}</strong></li>
			...
			<c:otherwise>
				...
				<div id="header-login" class="col-md-5 col-md-offset-1 col-sm-6 col-xs-7">
									
					<div class="row">
						<div class="area-log col-md-8 col-sm-8 col-xs-9">
<!-- 							BUTTON LOGIN -->
...
<!-- 							Modal Login  -->
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<form novalidate="novalidate" id="loginForm" role="form"
												...
												<div
													class="form-group  ${error != null ? 'has-error' : ''} has-feedback-left">
													<span>${message}</span> <input aria-required="true"
														name="username" placeholder="Your email address"
												...
												<div class="row no-margin-horizon ">
													<span class="ladda-label">Ban chua la thanh vien ?<a
														href="registration" data-target="#carousel-login"
														data-slide-to="1">Sign Up</a></span>
												</div>
												<hr class="form-authentication--breakline">
												<div class="row no-margin-horizon">
		...
		<!-- 							MODAL REGISTER -->
						...
						<div id="lang" class="col-md-4 col-sm-4 col-xs-3">
